...
mixin _$MapUiEvent {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function() clickMaka,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function()? clickMaka,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$ClickMakaImpl with DiagnosticableTreeMixin implements ClickMaka {
  const _$ClickMakaImpl();

  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'MapUiEvent.clickMaka()';
  }

  @override
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty('type', 'MapUiEvent.clickMaka'));
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _$ClickMakaImpl);
  }
...
abstract class ClickMaka implements MapUiEvent {
  const factory ClickMaka() = _$ClickMakaImpl;
}
