...
class _$ChangeColorImpl with DiagnosticableTreeMixin implements ChangeColor {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'AddEditNoteEvent.changeColor'))
...
class _$SaveNoteImpl with DiagnosticableTreeMixin implements SaveNote {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'AddEditNoteEvent.saveNote'))
